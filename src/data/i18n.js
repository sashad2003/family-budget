...
export const DICT = {
  ...
  'mail.bodyPlaceholder': {
    ru: 'Текст письма. Пустая строка разделяет абзацы; можно писать и разметкой — заголовки, картинки, кнопки.',
    en: 'The letter. A blank line separates paragraphs; markup works too — headings, images, buttons.',
    he: 'תוכן המכתב. שורה ריקה מפרידה בין פסקאות; אפשר גם קוד — כותרות, תמונות, כפתורים.',
  },
  ...
  'mail.templateName': {
    ru: 'Под каким именем сохранить письмо?',
    en: 'Save the letter under what name?',
    he: 'באיזה שם לשמור את המכתב?',
  },
  'mail.templateSaved': { ru: 'Сохранено: {name}', en: 'Saved: {name}', he: 'נשמר: {name}' },
  'mail.templateLoaded': { ru: 'Открыто: {name}', en: 'Opened: {name}', he: 'נפתח: {name}' },
  'mail.templateDelete': {
    ru: 'Какое письмо удалить? Есть: {names}',
    en: 'Which letter to delete? You have: {names}',
  ...
  // ---------------------------------------------------------------- админ-панель
  'admin.tabMine': { ru: 'Моя', en: 'Mine', he: 'שלי' },
  'admin.tabOthers': { ru: 'Остальные', en: 'Others', he: 'אחרים' },
  ...
  'admin.myItems': { ru: 'Купленных позиций', en: 'Purchased items', he: 'פריטים שנקנו' },
  ...
  // Расход на Claude: раздел админа о деньгах на распознавание чеков.
  'spend.title': { ru: 'Клод: расход и остаток', en: 'Claude: spending and balance', he: 'קלוד: הוצאה ויתרה' },
  'spend.left': { ru: 'Осталось на счету', en: 'Balance left', he: 'יתרה בחשבון' },
  'spend.leftUnknown': { ru: 'Не задан', en: 'Not set', he: 'לא הוגדר' },
  'spend.scansLeft': { ru: 'Хватит примерно на', en: 'Enough for about', he: 'יספיק לכ־' },
  'spend.scans': { ru: '{n} чеков', en: '{n} receipts', he: '{n} קבלות' },
  'spend.spentAll': { ru: 'Потрачено всего', en: 'Spent in total', he: 'הוצא בסך הכול' },
  'spend.spentMonth': { ru: 'В этом месяце', en: 'This month', he: 'החודש' },
  'spend.calls': { ru: 'Обращений к модели', en: 'Model calls', he: 'פניות למודל' },
  'spend.avg': { ru: 'В среднем за раз', en: 'Average per call', he: 'ממוצע לפנייה' },
  'spend.tokens': { ru: '{in} → {out} токенов', en: '{in} → {out} tokens', he: '{in} ← {out} טוקנים' },
  'spend.byMonth': { ru: 'По месяцам', en: 'By month', he: 'לפי חודשים' },
  'spend.balanceLabel': { ru: 'Остаток по кабинету Anthropic, $', en: 'Balance from the Anthropic console, $', he: 'יתרה לפי מסוף Anthropic, $' },
  ...
  'spend.hint': {
    ...
    en: 'Anthropic does not expose the remaining balance through the API — it is only visible in the console. Copy the number from there and the app will subtract the spending it counts on every receipt.',
    he: 'Anthropic אינה מוסרת את היתרה דרך ה־API — רואים אותה רק במסוף. העתיקו משם את המספר, והאפליקציה תפחית ממנו את ההוצאה שהיא סופרת בכל קבלה.',
  },
  'spend.notWritable': { ru: 'Сервер не может вести журнал: папке data рядом с api-proxy.php нужно право на запись.', en: 'The server cannot keep the ledger: the data folder next to api-proxy.php needs write permission.', he: 'השרת אינו יכול לנהל יומן: לתיקיית data ליד api-proxy.php דרושה הרשאת כתיבה.' },
  'spend.failed': { ru: 'Расход посчитать не удалось', en: 'Could not load spending', he: 'לא ניתן לטעון את ההוצאה' },
  'spend.since': { ru: 'Журнал ведётся с появления этого раздела: расход за прежние месяцы в него не попал.', en: 'The ledger starts when this section appeared: earlier months are not included.', he: 'היומן מתחיל עם הופעת החלק הזה: חודשים קודמים אינם נכללים.' },
  ...
  'admin.rowsShortOne': { ru: '{n} покупка', en: '{n} purchase', he: 'קנייה אחת' },
  'admin.purchases': { ru: 'покупок', en: 'purchases', he: 'קניות' },
  'admin.namesShort': { ru: '{n} названий', en: '{n} names', he: '{n} שמות' },
  'admin.namesShortOne': { ru: '{n} название', en: '{n} name', he: 'שם אחד' },
  ...
  'admin.shopMeta': { ru: '{items} · {rows}', en: '{items} · {rows}', he: '{items} · {rows}' },
  ...
  'scan.pasteFailed': { ru: 'Из буфера вставить не вышло — вставьте вручную', en: 'Could not paste from the clipboard — paste it by hand', he: 'לא ניתן להדביק מהלוח — הדביקו ידנית' },
  'qr.title': { ru: 'QR с чека', en: 'Receipt QR', he: 'QR מהקבלה' },
  'qr.aim': { ru: 'Наведите камеру на квадратный код на чеке. Как только он попадёт в кадр, чек начнёт читаться сам.', en: 'Point the camera at the square code on the receipt. As soon as it is in frame, the receipt starts loading.', he: 'כוונו את המצלמה לקוד המרובע שעל הקבלה. ברגע שהוא בפריים, הקבלה תיטען מעצמה.' },
  'qr.noCamera': { ru: 'Камера недоступна. Разрешите доступ к камере в настройках браузера или вставьте ссылку вручную.', en: 'The camera is unavailable. Allow camera access in the browser settings or paste the link by hand.', he: 'המצלמה אינה זמינה. אפשרו גישה למצלמה בהגדרות הדפדפן או הדביקו את הקישור ידנית.' },
  'scan.urlHint': {
  ...
  'rose.back': { ru: 'Вернуться в реальность', en: 'Back to reality', he: 'חזרה למציאות' },
