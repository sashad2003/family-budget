...
import { db } from '../core/firebase.js?v=16';
import { FAMILY_ID } from '../config.js?v=16';
import { DEFAULT_CATEGORIES } from '../data/categories.js?v=16';
import { amountsInAllCurrencies } from '../core/money.js?v=16';
import { monthOf } from '../core/dates.js?v=16';
