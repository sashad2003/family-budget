...
import { db } from '../core/firebase.js?v=11';
import { FAMILY_ID } from '../config.js?v=11';
import { DEFAULT_CATEGORIES } from '../data/categories.js?v=11';
import { amountsInAllCurrencies, round } from '../core/money.js?v=11';
import { monthOf } from '../core/dates.js?v=11';
