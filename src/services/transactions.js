...
import { db } from '../core/firebase.js?v=17';
import { FAMILY_ID } from '../config.js?v=17';
import { DEFAULT_CATEGORIES } from '../data/categories.js?v=17';
import { amountsInAllCurrencies } from '../core/money.js?v=17';
import { monthOf } from '../core/dates.js?v=17';
