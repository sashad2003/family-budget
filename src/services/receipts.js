...
import { PROXY_URL, CURRENCY_CODES } from '../config.js?v=123';
import { idToken } from './auth.js?v=123';
import { normalizeDate, today } from '../core/dates.js?v=123';
import { parseBankSms } from '../core/smsParse.js?v=123';
