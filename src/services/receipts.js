...
import { PROXY_URL, CURRENCY_CODES } from '../config.js?v=79';
import { idToken } from './auth.js?v=79';
import { normalizeDate, today } from '../core/dates.js?v=79';
import { parseBankSms } from '../core/smsParse.js?v=79';
