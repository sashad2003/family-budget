...
import { PROXY_URL, CURRENCY_CODES } from '../config.js?v=111';
import { idToken } from './auth.js?v=111';
import { normalizeDate, today } from '../core/dates.js?v=111';
import { parseBankSms } from '../core/smsParse.js?v=111';
