...
import { PROXY_URL, CURRENCY_CODES } from '../config.js?v=50';
import { idToken } from './auth.js?v=50';
import { normalizeDate, today } from '../core/dates.js?v=50';
import { parseBankSms } from '../core/smsParse.js?v=50';
