...
import { state, set, subscribe } from './core/store.js?v=113';
import { applyTheme } from './core/theme.js?v=113';
import { SUPPORT_WHATSAPP } from './config.js?v=113';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=113';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=113';
import { unpaidBills } from './core/selectors.js?v=113';

import { watchAuth, signIn } from './services/auth.js?v=113';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=113';
import { setFamilyId } from './core/session.js?v=113';
import { askProfile } from './views/signup.js?v=113';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=113';
import { watchBills } from './services/bills.js?v=113';
import { runAutoBills } from './services/autoBills.js?v=113';
import { loadRates } from './services/rates.js?v=113';

import { renderDashboard } from './views/dashboard.js?v=113';
import { renderList } from './views/list.js?v=113';
import { renderBills } from './views/bills.js?v=113';
import { renderPrices } from './views/prices.js?v=113';
import { renderAdmin } from './views/admin.js?v=113';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=113';
import { renderCharts, destroyCharts } from './views/charts.js?v=113';
import { renderSettings } from './views/settings.js?v=113';
import { openTxForm } from './views/txForm.js?v=113';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=113';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=113';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=113')
