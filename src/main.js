...
} from './core/i18n.js?v=123';
import { state, set, subscribe } from './core/store.js?v=123';
import { applyTheme } from './core/theme.js?v=123';
import { SUPPORT_WHATSAPP } from './config.js?v=123';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=123';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=123';
import { unpaidBills } from './core/selectors.js?v=123';

import { watchAuth, signIn } from './services/auth.js?v=123';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=123';
import { setFamilyId } from './core/session.js?v=123';
import { askProfile } from './views/signup.js?v=123';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=123';
import { watchBills } from './services/bills.js?v=123';
import { runAutoBills } from './services/autoBills.js?v=123';
import { loadRates } from './services/rates.js?v=123';

import { renderDashboard } from './views/dashboard.js?v=123';
import { renderList } from './views/list.js?v=123';
import { renderBills } from './views/bills.js?v=123';
import { renderPrices } from './views/prices.js?v=123';
import { renderAdmin } from './views/admin.js?v=123';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=123';
import { renderCharts, destroyCharts } from './views/charts.js?v=123';
import { renderSettings } from './views/settings.js?v=123';
import { openTxForm } from './views/txForm.js?v=123';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=123';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=123';
import { openSheet, closeSheet } from './ui/sheet.js?v=123';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=123')
