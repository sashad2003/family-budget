...
import { $, render } from './core/dom.js?v=94';
import {
  t, localeInfo, isRTL, applyDocumentLocale, translateDocument,
} from './core/i18n.js?v=94';
import { state, set, subscribe } from './core/store.js?v=94';
import { applyTheme } from './core/theme.js?v=94';
import { SUPPORT_WHATSAPP } from './config.js?v=94';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=94';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=94';
import { unpaidBills } from './core/selectors.js?v=94';

import { watchAuth, signIn } from './services/auth.js?v=94';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily,
} from './services/account.js?v=94';
import { setFamilyId } from './core/session.js?v=94';
import { askProfile } from './views/signup.js?v=94';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=94';
import { watchBills } from './services/bills.js?v=94';
import { runAutoBills } from './services/autoBills.js?v=94';
import { loadRates } from './services/rates.js?v=94';

import { renderDashboard } from './views/dashboard.js?v=94';
import { renderList } from './views/list.js?v=94';
import { renderBills } from './views/bills.js?v=94';
import { renderPrices } from './views/prices.js?v=94';
import { renderAdmin } from './views/admin.js?v=94';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=94';
import { renderCharts, destroyCharts } from './views/charts.js?v=94';
import { renderSettings } from './views/settings.js?v=94';
import { openTxForm } from './views/txForm.js?v=94';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=94';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=94';
import { closeSheet } from './ui/sheet.js?v=94';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=94')
