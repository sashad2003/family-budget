...
} from './core/i18n.js?v=121';
import { state, set, subscribe } from './core/store.js?v=121';
import { applyTheme } from './core/theme.js?v=121';
import { SUPPORT_WHATSAPP } from './config.js?v=121';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=121';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=121';
import { unpaidBills } from './core/selectors.js?v=121';

import { watchAuth, signIn } from './services/auth.js?v=121';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=121';
import { setFamilyId } from './core/session.js?v=121';
import { askProfile } from './views/signup.js?v=121';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=121';
import { watchBills } from './services/bills.js?v=121';
import { runAutoBills } from './services/autoBills.js?v=121';
import { loadRates } from './services/rates.js?v=121';

import { renderDashboard } from './views/dashboard.js?v=121';
import { renderList } from './views/list.js?v=121';
import { renderBills } from './views/bills.js?v=121';
import { renderPrices } from './views/prices.js?v=121';
import { renderAdmin } from './views/admin.js?v=121';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=121';
import { renderCharts, destroyCharts } from './views/charts.js?v=121';
import { renderSettings } from './views/settings.js?v=121';
import { openTxForm } from './views/txForm.js?v=121';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=121';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=121';
import { openSheet, closeSheet } from './ui/sheet.js?v=121';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=121')
