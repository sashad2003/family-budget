...
} from './core/i18n.js?v=124';
import { state, set, subscribe } from './core/store.js?v=124';
import { applyTheme } from './core/theme.js?v=124';
import { SUPPORT_WHATSAPP } from './config.js?v=124';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=124';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=124';
import { unpaidBills } from './core/selectors.js?v=124';

import { watchAuth, signIn } from './services/auth.js?v=124';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=124';
import { setFamilyId } from './core/session.js?v=124';
import { askProfile } from './views/signup.js?v=124';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=124';
import { watchBills } from './services/bills.js?v=124';
import { runAutoBills } from './services/autoBills.js?v=124';
import { loadRates } from './services/rates.js?v=124';

import { renderDashboard } from './views/dashboard.js?v=124';
import { renderList } from './views/list.js?v=124';
import { renderBills } from './views/bills.js?v=124';
import { renderPrices } from './views/prices.js?v=124';
import { renderAdmin } from './views/admin.js?v=124';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=124';
import { renderCharts, destroyCharts } from './views/charts.js?v=124';
import { renderSettings } from './views/settings.js?v=124';
import { openTxForm } from './views/txForm.js?v=124';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=124';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=124';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=124')
