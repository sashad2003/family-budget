...
import { $, render } from './core/dom.js?v=85';
import {
  t, localeInfo, isRTL, applyDocumentLocale, translateDocument,
} from './core/i18n.js?v=85';
import { state, set, subscribe } from './core/store.js?v=85';
import { applyTheme } from './core/theme.js?v=85';
import { SUPPORT_WHATSAPP } from './config.js?v=85';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=85';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=85';
import { unpaidBills } from './core/selectors.js?v=85';

import { watchAuth, signIn } from './services/auth.js?v=85';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily,
} from './services/account.js?v=85';
import { setFamilyId } from './core/session.js?v=85';
import { askProfile } from './views/signup.js?v=85';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=85';
import { watchBills } from './services/bills.js?v=85';
import { runAutoBills } from './services/autoBills.js?v=85';
import { loadRates } from './services/rates.js?v=85';

import { renderDashboard } from './views/dashboard.js?v=85';
import { renderList } from './views/list.js?v=85';
import { renderBills } from './views/bills.js?v=85';
import { renderPrices } from './views/prices.js?v=85';
import { renderAdmin } from './views/admin.js?v=85';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=85';
import { renderCharts, destroyCharts } from './views/charts.js?v=85';
import { renderSettings } from './views/settings.js?v=85';
import { openTxForm } from './views/txForm.js?v=85';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=85';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=85';
import { closeSheet } from './ui/sheet.js?v=85';
import { toastError, toastOk } from './ui/toast.js?v=85';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=85')
