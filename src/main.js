...
} from './core/i18n.js?v=120';
import { state, set, subscribe } from './core/store.js?v=120';
import { applyTheme } from './core/theme.js?v=120';
import { SUPPORT_WHATSAPP } from './config.js?v=120';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=120';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=120';
import { unpaidBills } from './core/selectors.js?v=120';

import { watchAuth, signIn } from './services/auth.js?v=120';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=120';
import { setFamilyId } from './core/session.js?v=120';
import { askProfile } from './views/signup.js?v=120';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=120';
import { watchBills } from './services/bills.js?v=120';
import { runAutoBills } from './services/autoBills.js?v=120';
import { loadRates } from './services/rates.js?v=120';

import { renderDashboard } from './views/dashboard.js?v=120';
import { renderList } from './views/list.js?v=120';
import { renderBills } from './views/bills.js?v=120';
import { renderPrices } from './views/prices.js?v=120';
import { renderAdmin } from './views/admin.js?v=120';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=120';
import { renderCharts, destroyCharts } from './views/charts.js?v=120';
import { renderSettings } from './views/settings.js?v=120';
import { openTxForm } from './views/txForm.js?v=120';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=120';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=120';
import { openSheet, closeSheet } from './ui/sheet.js?v=120';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=120')
