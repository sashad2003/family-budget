...
import { $, render } from './core/dom.js?v=103';
import {
  t, localeInfo, isRTL, applyDocumentLocale, translateDocument,
} from './core/i18n.js?v=103';
import { state, set, subscribe } from './core/store.js?v=103';
import { applyTheme } from './core/theme.js?v=103';
import { SUPPORT_WHATSAPP } from './config.js?v=103';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=103';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=103';
import { unpaidBills } from './core/selectors.js?v=103';

import { watchAuth, signIn } from './services/auth.js?v=103';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=103';
import { setFamilyId } from './core/session.js?v=103';
import { askProfile } from './views/signup.js?v=103';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=103';
import { watchBills } from './services/bills.js?v=103';
import { runAutoBills } from './services/autoBills.js?v=103';
import { loadRates } from './services/rates.js?v=103';

import { renderDashboard } from './views/dashboard.js?v=103';
import { renderList } from './views/list.js?v=103';
import { renderBills } from './views/bills.js?v=103';
import { renderPrices } from './views/prices.js?v=103';
import { renderAdmin } from './views/admin.js?v=103';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=103';
import { renderCharts, destroyCharts } from './views/charts.js?v=103';
import { renderSettings } from './views/settings.js?v=103';
import { openTxForm } from './views/txForm.js?v=103';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=103';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=103';
import { closeSheet } from './ui/sheet.js?v=103';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=103')
