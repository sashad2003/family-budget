...
import { $, render } from './core/dom.js?v=104';
import {
  t, localeInfo, isRTL, applyDocumentLocale, translateDocument,
} from './core/i18n.js?v=104';
import { state, set, subscribe } from './core/store.js?v=104';
import { applyTheme } from './core/theme.js?v=104';
import { SUPPORT_WHATSAPP } from './config.js?v=104';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=104';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=104';
import { unpaidBills } from './core/selectors.js?v=104';

import { watchAuth, signIn } from './services/auth.js?v=104';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=104';
import { setFamilyId } from './core/session.js?v=104';
import { askProfile } from './views/signup.js?v=104';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=104';
import { watchBills } from './services/bills.js?v=104';
import { runAutoBills } from './services/autoBills.js?v=104';
import { loadRates } from './services/rates.js?v=104';

import { renderDashboard } from './views/dashboard.js?v=104';
import { renderList } from './views/list.js?v=104';
import { renderBills } from './views/bills.js?v=104';
import { renderPrices } from './views/prices.js?v=104';
import { renderAdmin } from './views/admin.js?v=104';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=104';
import { renderCharts, destroyCharts } from './views/charts.js?v=104';
import { renderSettings } from './views/settings.js?v=104';
import { openTxForm } from './views/txForm.js?v=104';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=104';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=104';
import { closeSheet } from './ui/sheet.js?v=104';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=104')
