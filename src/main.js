...
import { $, render } from './core/dom.js?v=40';
import { t, applyDocumentLocale, translateDocument } from './core/i18n.js?v=40';
import { state, set, subscribe } from './core/store.js?v=40';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=40';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=40';
import { unpaidBills } from './core/selectors.js?v=40';

import { watchAuth, signIn } from './services/auth.js?v=40';
import { loadAccount, isAdmin, joinByCode, listFamilies } from './services/account.js?v=40';
import { setFamilyId } from './core/session.js?v=40';
import { askProfile } from './views/signup.js?v=40';
import {
  watchTransactions,
  watchCategories,
  seedCategoriesIfEmpty,
  syncNewCategories,
} from './services/transactions.js?v=40';
import { watchBills } from './services/bills.js?v=40';
import { loadRates } from './services/rates.js?v=40';

import { renderDashboard } from './views/dashboard.js?v=40';
import { renderList } from './views/list.js?v=40';
import { renderBills } from './views/bills.js?v=40';
import { renderPrices } from './views/prices.js?v=40';
import { renderAdmin } from './views/admin.js?v=40';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=40';
import { renderCharts, destroyCharts } from './views/charts.js?v=40';
import { renderSettings } from './views/settings.js?v=40';
import { openTxForm } from './views/txForm.js?v=40';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=40';
import { closeSheet } from './ui/sheet.js?v=40';
import { toastError, toastOk } from './ui/toast.js?v=40';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=40')
