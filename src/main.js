...
import { state, set, subscribe } from './core/store.js?v=114';
import { applyTheme } from './core/theme.js?v=114';
import { SUPPORT_WHATSAPP } from './config.js?v=114';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=114';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=114';
import { unpaidBills } from './core/selectors.js?v=114';

import { watchAuth, signIn } from './services/auth.js?v=114';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=114';
import { setFamilyId } from './core/session.js?v=114';
import { askProfile } from './views/signup.js?v=114';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=114';
import { watchBills } from './services/bills.js?v=114';
import { runAutoBills } from './services/autoBills.js?v=114';
import { loadRates } from './services/rates.js?v=114';

import { renderDashboard } from './views/dashboard.js?v=114';
import { renderList } from './views/list.js?v=114';
import { renderBills } from './views/bills.js?v=114';
import { renderPrices } from './views/prices.js?v=114';
import { renderAdmin } from './views/admin.js?v=114';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=114';
import { renderCharts, destroyCharts } from './views/charts.js?v=114';
import { renderSettings } from './views/settings.js?v=114';
import { openTxForm } from './views/txForm.js?v=114';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=114';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=114';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=114')
