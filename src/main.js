...
} from './core/i18n.js?v=122';
import { state, set, subscribe } from './core/store.js?v=122';
import { applyTheme } from './core/theme.js?v=122';
import { SUPPORT_WHATSAPP } from './config.js?v=122';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=122';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=122';
import { unpaidBills } from './core/selectors.js?v=122';

import { watchAuth, signIn } from './services/auth.js?v=122';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily, setMarketing,
} from './services/account.js?v=122';
import { setFamilyId } from './core/session.js?v=122';
import { askProfile } from './views/signup.js?v=122';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=122';
import { watchBills } from './services/bills.js?v=122';
import { runAutoBills } from './services/autoBills.js?v=122';
import { loadRates } from './services/rates.js?v=122';

import { renderDashboard } from './views/dashboard.js?v=122';
import { renderList } from './views/list.js?v=122';
import { renderBills } from './views/bills.js?v=122';
import { renderPrices } from './views/prices.js?v=122';
import { renderAdmin } from './views/admin.js?v=122';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=122';
import { renderCharts, destroyCharts } from './views/charts.js?v=122';
import { renderSettings } from './views/settings.js?v=122';
import { openTxForm } from './views/txForm.js?v=122';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=122';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=122';
import { openSheet, closeSheet } from './ui/sheet.js?v=122';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=122')
