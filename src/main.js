...
import { $, render } from './core/dom.js?v=97';
import {
  t, localeInfo, isRTL, applyDocumentLocale, translateDocument,
} from './core/i18n.js?v=97';
import { state, set, subscribe } from './core/store.js?v=97';
import { applyTheme } from './core/theme.js?v=97';
import { SUPPORT_WHATSAPP } from './config.js?v=97';
import { openBaseCurrencyPicker } from './views/currencyPicker.js?v=97';
import { monthKey, monthLabel, shiftMonth } from './core/dates.js?v=97';
import { unpaidBills } from './core/selectors.js?v=97';

import { watchAuth, signIn } from './services/auth.js?v=97';
import {
  loadAccount, isAdmin, joinByCode, listFamilies, watchFamily,
} from './services/account.js?v=97';
import { setFamilyId } from './core/session.js?v=97';
import { askProfile } from './views/signup.js?v=97';
import {
  watchTransactions,
  watchCategories,
  ...
  syncNewCategories,
  retireTealColor,
} from './services/transactions.js?v=97';
import { watchBills } from './services/bills.js?v=97';
import { runAutoBills } from './services/autoBills.js?v=97';
import { loadRates } from './services/rates.js?v=97';

import { renderDashboard } from './views/dashboard.js?v=97';
import { renderList } from './views/list.js?v=97';
import { renderBills } from './views/bills.js?v=97';
import { renderPrices } from './views/prices.js?v=97';
import { renderAdmin } from './views/admin.js?v=97';
import { openBudgetMenu, budgetName } from './views/budgetMenu.js?v=97';
import { renderCharts, destroyCharts } from './views/charts.js?v=97';
import { renderSettings } from './views/settings.js?v=97';
import { openTxForm } from './views/txForm.js?v=97';
import { openMoreMenu, MORE_ROUTES } from './views/moreMenu.js?v=97';
import { initRoseButton, drawRoseButton, resetRose } from './views/roseGlasses.js?v=97';
import { closeSheet } from './ui/sheet.js?v=97';
...
function shareOldPrices(transactions) {
  ...
  import('./services/prices.js?v=97')
