...
import { dayLabel } from '../core/dates.js?v=52';
import { searchPrices, groupByShop } from '../services/prices.js?v=52';
import { quickItemSuggestions } from '../core/selectors.js?v=52';
import { toastError } from '../ui/toast.js?v=52';
import { tileGradient } from './list.js?v=52';
import { openTxForm } from './txForm.js?v=52';
import { section } from '../ui/section.js?v=52';
import { t, getLocale } from '../core/i18n.js?v=52';
