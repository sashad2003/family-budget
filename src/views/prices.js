...
import { dayLabel } from '../core/dates.js?v=80';
import { searchPrices, groupByShop } from '../services/prices.js?v=80';
import { quickItemSuggestions } from '../core/selectors.js?v=80';
import { toastError } from '../ui/toast.js?v=80';
import { tileGradient } from './list.js?v=80';
import { openTxForm } from './txForm.js?v=80';
import { section } from '../ui/section.js?v=80';
import { t, getLocale } from '../core/i18n.js?v=80';
