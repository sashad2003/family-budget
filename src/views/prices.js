...
import { searchPrices, groupByShop } from '../services/prices.js?v=84';
import { quickItemSuggestions } from '../core/selectors.js?v=84';
import { toastError } from '../ui/toast.js?v=84';
