...
import { dayLabel } from '../core/dates.js?v=63';
import { searchPrices, groupByShop } from '../services/prices.js?v=63';
import { quickItemSuggestions } from '../core/selectors.js?v=63';
import { toastError } from '../ui/toast.js?v=63';
import { tileGradient } from './list.js?v=63';
import { openTxForm } from './txForm.js?v=63';
import { section } from '../ui/section.js?v=63';
import { t, getLocale } from '../core/i18n.js?v=63';
