...
import { searchPrices, groupByShop } from '../services/prices.js?v=69';
import { quickItemSuggestions } from '../core/selectors.js?v=69';
import { toastError } from '../ui/toast.js?v=69';
