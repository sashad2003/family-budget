...
import { dayLabel } from '../core/dates.js?v=122';
import { searchPrices, groupByShop } from '../services/prices.js?v=122';
import { quickItemSuggestions } from '../core/selectors.js?v=122';
import { toastError } from '../ui/toast.js?v=122';
import { tileStyle } from './list.js?v=122';
import { openTxForm } from './txForm.js?v=122';
import { section } from '../ui/section.js?v=122';
import { t, getLocale } from '../core/i18n.js?v=122';
