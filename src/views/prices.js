...
import { searchPrices, groupByShop } from '../services/prices.js?v=83';
import { quickItemSuggestions } from '../core/selectors.js?v=83';
import { toastError } from '../ui/toast.js?v=83';
