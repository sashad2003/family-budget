...
import { dayLabel } from '../core/dates.js?v=64';
import { searchPrices, groupByShop } from '../services/prices.js?v=64';
import { quickItemSuggestions } from '../core/selectors.js?v=64';
import { toastError } from '../ui/toast.js?v=64';
import { tileGradient } from './list.js?v=64';
import { openTxForm } from './txForm.js?v=64';
import { section } from '../ui/section.js?v=64';
import { t, getLocale } from '../core/i18n.js?v=64';
