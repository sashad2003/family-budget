...
import { searchPrices, groupByShop } from '../services/prices.js?v=82';
import { quickItemSuggestions } from '../core/selectors.js?v=82';
import { toastError } from '../ui/toast.js?v=82';
