...
import { searchPrices, groupByShop } from '../services/prices.js?v=68';
import { quickItemSuggestions } from '../core/selectors.js?v=68';
import { toastError } from '../ui/toast.js?v=68';
