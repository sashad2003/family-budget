...
import { state } from '../core/store.js?v=110';
import { formatAmount, convert } from '../core/money.js?v=110';
import { dayLabel } from '../core/dates.js?v=110';
import { searchPrices, groupByShop } from '../services/prices.js?v=110';
import { quickItemSuggestions } from '../core/selectors.js?v=110';
import { toastError } from '../ui/toast.js?v=110';
import { tileStyle } from './list.js?v=110';
import { openTxForm } from './txForm.js?v=110';
import { section } from '../ui/section.js?v=110';
import { t, getLocale } from '../core/i18n.js?v=110';
...
function shopRow(shop, cheapest) {
  ...
  return el(source ? 'button' : 'div', {
    ...
    el('div', {
      class: 'tx__ico',
      style: tileStyle(overpay === 0 ? '#2dd98a' : '#5b9fff'),
    }, '🏪'),
