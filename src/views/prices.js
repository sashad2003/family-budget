...
import { searchPrices, groupByShop } from '../services/prices.js?v=56';
import { quickItemSuggestions } from '../core/selectors.js?v=56';
import { toastError } from '../ui/toast.js?v=56';
