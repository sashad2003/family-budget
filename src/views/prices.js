...
import { dayLabel } from '../core/dates.js?v=123';
import { searchPrices, groupByShop } from '../services/prices.js?v=123';
import { quickItemSuggestions } from '../core/selectors.js?v=123';
import { toastError } from '../ui/toast.js?v=123';
import { tileStyle } from './list.js?v=123';
import { openTxForm } from './txForm.js?v=123';
import { section } from '../ui/section.js?v=123';
import { t, getLocale } from '../core/i18n.js?v=123';
