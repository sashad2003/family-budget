...
import { formatAmount, txAmountIn } from '../core/money.js?v=19';
import { dayLabel } from '../core/dates.js?v=19';
import { monthTransactions, groupByDate, totals } from '../core/selectors.js?v=19';
