...
import { formatAmount, txAmountIn } from '../core/money.js?v=5';
import { dayLabel } from '../core/dates.js?v=5';
import { monthTransactions, groupByDate, totals } from '../core/selectors.js?v=5';
