...
import { state, set } from '../core/store.js?v=5';
import { CURRENCY_CODES } from '../config.js?v=5';
import { formatAmount, parseAmount, currencyInfo } from '../core/money.js?v=5';
import { monthLabel, monthKey, today } from '../core/dates.js?v=5';
import { billsForMonth } from '../core/selectors.js?v=5';
import { createBill, updateBill, deleteBill } from '../services/bills.js?v=5';
import { createTransaction } from '../services/transactions.js?v=5';
...
export function renderBills() {
  ...
  render(container, [
    ...
    el('div', { class: 'bills' }, rows.map((row) => billRow(row))),
