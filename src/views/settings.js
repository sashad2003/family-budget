...
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=5';
import { formatAmount, convert } from '../core/money.js?v=5';
import { logout } from '../services/auth.js?v=5';
import { refreshRates } from '../services/rates.js?v=5';
import { saveCategory, deleteCategory } from '../services/transactions.js?v=5';
