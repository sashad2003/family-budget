...
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=12';
import { formatAmount, convert } from '../core/money.js?v=12';
import { logout } from '../services/auth.js?v=12';
import { refreshRates } from '../services/rates.js?v=12';
import { saveCategory, deleteCategory } from '../services/transactions.js?v=12';
