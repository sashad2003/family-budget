...
import { state, set } from '../core/store.js?v=115';
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=115';
import { formatAmount, convert } from '../core/money.js?v=115';
import { logout } from '../services/auth.js?v=115';
import {
  inviteLink, resetInviteLink, removeMember, leaveFamily, isOwner, setMarketing, wantsMail,
} from '../services/account.js?v=115';
import { refreshRates } from '../services/rates.js?v=115';
import { saveCategory, deleteCategory, reorderCategories } from '../services/transactions.js?v=115';
import { openSheet, closeSheet, confirmSheet } from '../ui/sheet.js?v=115';
import { section } from '../ui/section.js?v=115';
import { t, intlLocale } from '../core/i18n.js?v=115';
import { THEMES, getTheme, setTheme } from '../core/theme.js?v=115';
...
function openCategoryEditor(cat, onDone) {
  ...
  import('../ui/emojiPicker.js?v=115')
