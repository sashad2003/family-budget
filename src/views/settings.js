...
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=8';
import { formatAmount, convert } from '../core/money.js?v=8';
import { logout } from '../services/auth.js?v=8';
import { refreshRates } from '../services/rates.js?v=8';
import { saveCategory, deleteCategory } from '../services/transactions.js?v=8';
