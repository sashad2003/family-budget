...
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=113';
import { formatAmount, convert } from '../core/money.js?v=113';
import { logout } from '../services/auth.js?v=113';
import {
  inviteLink, resetInviteLink, removeMember, leaveFamily, isOwner, setMarketing, wantsMail,
} from '../services/account.js?v=113';
import { refreshRates } from '../services/rates.js?v=113';
import { saveCategory, deleteCategory, reorderCategories } from '../services/transactions.js?v=113';
import { openSheet, closeSheet, confirmSheet } from '../ui/sheet.js?v=113';
import { section } from '../ui/section.js?v=113';
import { t, intlLocale } from '../core/i18n.js?v=113';
import { THEMES, getTheme, setTheme } from '../core/theme.js?v=113';
...
function openCategoryEditor(cat, onDone) {
  ...
  import('../ui/emojiPicker.js?v=113')
