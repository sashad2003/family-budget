...
import { CURRENCY_CODES, CURRENCIES } from '../config.js?v=18';
import { formatAmount, convert } from '../core/money.js?v=18';
import { logout } from '../services/auth.js?v=18';
import { refreshRates } from '../services/rates.js?v=18';
import { saveCategory, deleteCategory } from '../services/transactions.js?v=18';
