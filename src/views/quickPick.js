...
import { quickItemSuggestions } from '../core/selectors.js?v=5';
import { DEFAULT_QUICK_ITEMS } from '../data/quickItems.js?v=5';
import { openSheet, closeSheet } from '../ui/sheet.js?v=5';
